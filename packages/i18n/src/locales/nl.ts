...
export const nl = {
  ...
  'listings.detail.back': 'Terug naar listings',
  'listings.detail.edit': 'Bewerken',
  'listings.detail.photos.cta': 'Foto’s beheren',
  'listings.detail.section.description': 'Beschrijving',
  'listings.detail.section.pricing': 'Prijzen',
  'listings.detail.field.bedrooms': 'Slaapkamers',
  'listings.detail.field.bathrooms': 'Badkamers',
  'listings.detail.field.surface': 'Oppervlakte',
  'listings.detail.field.propertyType': 'Type pand',
  'listings.detail.field.leaseType': 'Huurtype',
  'listings.detail.field.minLease': 'Min. huurperiode',
  'listings.detail.field.minLeaseValue': '{months} maanden',
  'listings.detail.price.rent': 'Huur per maand',
  'listings.detail.price.charges': 'Vaste lasten',
  'listings.detail.price.syndic': 'Syndic',
  'listings.detail.price.deposit': 'Waarborg',
  'listings.detail.price.agencyFee': 'Makelaarskosten',
  'listings.detail.price.includesUtilities':
    'Energie en water inbegrepen in de huur.',
  'listings.detail.timestamps.created': 'Aangemaakt op {date}',
  'listings.detail.timestamps.updated': 'Bijgewerkt op {date}',
  'listings.detail.propertyType.apartment': 'Appartement',
  'listings.detail.propertyType.house': 'Woning',
  'listings.detail.propertyType.studio': 'Studio',
  'listings.detail.propertyType.loft': 'Loft',
  'listings.detail.propertyType.commercial': 'Handelspand',
  'listings.detail.propertyType.office': 'Kantoor',
  'listings.detail.propertyType.garage': 'Garage',
  'listings.detail.propertyType.land': 'Grond',
  'listings.detail.leaseType.long_term_residential': 'Lange termijn',
  'listings.detail.leaseType.short_term': 'Korte termijn',
  'listings.detail.leaseType.student': 'Studentenhuur',
  'listings.detail.leaseType.commercial': 'Commercieel',
